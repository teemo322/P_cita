...
<div class="main-panel">
     ...
     <div class="page-header">
          ...
          <ul class="breadcrumbs">
               ...
               <li class="nav-item">
                    <a href="../citas/mostrar.php">mostrar</a>
               </li>
...
require '../../backend/db/config.php';
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT appointment.codcit, appointment.dates, appointment.hour,customers.codpaci,customers.apellidop,customers.nombrep,doctor.apedoc,doctor.nomdoc, specialty.nombrees, appointment.estado, appointment.fecha_create FROM appointment INNER JOIN customers ON appointment.codpaci = customers.codpaci INNER JOIN doctor ON appointment.coddoc = doctor.coddoc INNER JOIN specialty ON appointment.codespe = specialty.codespe  WHERE codcit= '$id';");
 $sentencia->execute();
...
<div class="row">
  <div class="col-md-6 col-lg-6">
     ...
     <input type="text" required id="nombres" readonly class="form-control" onkeypress="return soloLetras(event)" name="nompac" value="<?php echo $d->dates  ?>" style="color: black;" placeholder="Enter paciente">
     <small id="emailHelp2" class="form-text text-muted">We'll never share your email with anyone else.</small>   
  </div>  

  <div class="col-md-6 col-lg-6">
     <label for="email2">Hora</label>
     <input type="text" required id="apellidoPaterno" class="form-control" onkeypress="return soloLetras(event)" name="apepac" value="<?php echo $d->hour  ?>" style="color: black;" readonly placeholder="Enter paciente">
     <small id="emailHelp2" class="form-text text-muted">We'll never share your email with anyone else.</small>   
  </div>                    
</div>
...
<div class="row">
  <div class="col-md-6 col-lg-6">
     <label for="email2">Paciente</label>
     <input type="text" required id="nombres" readonly class="form-control" onkeypress="return soloLetras(event)" name="nompac" value="<?php echo $d->apellidop  ?> <?php echo $d->nombrep  ?>" style="color: black;" placeholder="Enter paciente">
     <small id="emailHelp2" class="form-text text-muted">We'll never share your email with anyone else.</small>   
  </div>  

  <div class="col-md-6 col-lg-6">
     <label for="email2">Área</label>
...
<div class="row">
  <div class="col-md-12 col-lg-12">
     <label for="email2">Médico</label>
     <input type="text" required id="nombres" readonly class="form-control" onkeypress="return soloLetras(event)" name="nompac" value="<?php echo $d->apedoc  ?> <?php echo $d->nomdoc  ?>" style="color: black;" placeholder="Enter paciente">
     <small id="emailHelp2" class="form-text text-muted">We'll never share your email with anyone else.</small>   
  </div>  
   ...
   No hay datos.
    ...
    <?php endif; ?>
     ...
     <?php
    include_once '../../backend/php/upd_appoint.php'
?>
