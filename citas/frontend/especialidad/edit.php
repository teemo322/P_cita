...
<div class="main-panel">
     ...
     <div class="page-header">
          ...
          <ul class="breadcrumbs">
               ...
               <li class="nav-item">
                    <a href="../especialidad/mostrar.php">mostrar</a>
               </li>
...
require '../../backend/db/config.php';
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT * FROM specialty  WHERE codespe= '$id';");
 $sentencia->execute();
  ...
  while($r = $sentencia->fetchObject()){
               ...
               <form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
                 <div class="row">
                  <div class="col-md-12 col-lg-12">
                    ...
                    <label for="email2">Nombre de la especialidad</label>
                    <input type="text" required class="form-control" name="namees" value="<?php echo $d->nombrees  ?>" placeholder="Enter Email">
                    <input type="hidden" name="esid" value="<?php echo $d->codespe  ?>">
               <small id="emailHelp2" class="form-text text-muted">We'll never share your email with anyone else.</small>
                    </div>  
                  </div>    
                 </div> 
                 <div class="card-action">
                         <button type="submit" name="upd_speciality" class="btn btn-success">Agregar</button>
   ...
   No hay datos.
    ...
    <?php endif; ?>
     ...
     <?php
    include_once '../../backend/php/upd_speciality.php'
?>
