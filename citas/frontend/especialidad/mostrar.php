             ...
             <div class="col-md-12">
                <div class="card">
                   <div class="card-header">
                    ...
                    <?php include('../../backend/modal/modalAddSpe.php'); ?>
                    </div>
                    <div class="card-tools">
                    <a href="../especialidad/reporte.php" class="btn btn-info btn-border btn-round btn-sm mr-2">
...
$sentencia = $connect->prepare("SELECT * FROM specialty ORDER BY codespe DESC;");
 $sentencia->execute();
$data =  array();
if($sentencia){
...
<?php if(count($data)>0):?>
          ...
          <tr>
          <td><?php echo $d->codespe  ?></td>
          <td><?php echo $d->nombrees  ?></td>
          <td><?php echo $d->fecha_create  ?></td>
          <td>
          <div class="form-button-action">
          
          <button onclick="location.href='../especialidad/edit.php?id=<?php echo $d->codespe ?>'" class="btn btn-link btn-primary btn-lg" data-toggle="modal"  title="" data-original-title="Edit Task">
          <i class="fa fa-edit"></i>
          </button> 

          <button onclick="location.href='../especialidad/delete.php?id=<?php echo $d->codespe ?>'" class="btn btn-link btn-danger btn-lg" data-toggle="modal"  title="" data-original-title="Delete Task">
   ...
   No hay datos.
    ...
    <?php endif; ?>   
     ...
     <?php
    include_once '../../backend/php/add_speciality.php'
?>
