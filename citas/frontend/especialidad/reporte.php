...
$this->Cell(150, 8, 'Especialidades',0,1);

$this->SetY(45);
$this->SetX(247);
$this->SetFont('Arial','',8);
$this->Cell(40, 8, utf8_decode('Reporte de especialidades'));
...
$pdf->Cell(185, 12, utf8_decode('ESPECIALIDAD'),1,0,'C',1);
$pdf->Cell(45, 12, utf8_decode('FECHA'),1,1,'C',1);
...
$stmt = $connect->prepare("SELECT * FROM specialty ORDER BY codespe DESC");
...
$pdf->Cell(35, 8, utf8_decode($row['codespe']),'B',0,'C',1);
$pdf->Cell(185, 8, utf8_decode($row['nombrees']),'B',0,'C',1);
$pdf->Cell(45, 8, utf8_decode($row['fecha_create']),'B',1,'C',1);
