...
<div class="main-panel">
     ...
     <div class="page-header">
          ...
          <ul class="breadcrumbs">
               ...
               <li class="nav-item">
                    <a href="../horarios/mostrar.php">mostrar</a>
               </li>
...
require '../../backend/db/config.php';
 $id = $_GET['id'];
 $sentencia = $connect->prepare("SELECT horario.codhor, horario.nomhor, doctor.coddoc, doctor.dnidoc, doctor.nomdoc, doctor.apedoc, doctor.correo, horario.fere FROM horario INNER JOIN doctor ON  horario.coddoc = doctor.coddoc  WHERE codhor= '$id';");
 $sentencia->execute();
  ...
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?>
        <?php foreach($data as $d):?>
               <form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
                 <div class="row">
                  <div class="col-md-6 col-lg-6">
                    ...
                    <label for="email2">Nombre del horario</label>
                    <input type="text" required class="form-control" name="nameho" value="<?php echo $d->nomhor   ?>" placeholder="Enter Email">
                    <input type="hidden" name="horid" value="<?php echo $d->codhor  ?>">
               <small id="emailHelp2" class="form-text text-muted">We'll never share your email with anyone else.</small>
                  ...
                  <div class="col-md-6 col-lg-6">
                     <div class="form-group">
                       <label for="email2">Nombre del medico</label>
                       <select class="form-control" required name="namedoc">
                      <option value="<?php echo $d->coddoc  ?>"><?php echo $d->apedoc  ?> <?php echo $d->nomdoc  ?></option>
                      <option>--------Seleccione--------------</option>
                      <?php
               $stmt = $connect->prepare('SELECT * FROM doctor'); 
                $stmt->execute();
                ...
                while($row=$stmt->fetch(PDO::FETCH_ASSOC))
             {
                ...
                ?>          
                 ...
                 <div class="card-action">
                         <button type="submit" name="upd_horari" class="btn btn-success">Agregar</button>
   ...
   No hay datos.
    ...
    <?php endif; ?>
     ...
     <?php
    include_once '../../backend/php/upd_hora.php'
?>
