               ...
               <form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
                 ...
                 <div class="row">
                  <div class="col-md-12 col-lg-12">
                    ...
                    <label for="email2">Expediente del médico</label> <button type="button" id="buscar" class="btn btn-icon btn-round btn-dark">
...
<div class="row">
   <div class="col-md-6 col-lg-6">
       ...
       <select class="form-control" name="espdo"  required>
...
<div class="card-action">
     <button type="submit" name="upd_doct" class="btn btn-success">Agregar</button>
   ...
   No hay datos.
    ...
    <?php endif; ?>
     ...
     <?php
    include_once '../../backend/php/upd_docto.php'
?>
