             ...
             <div class="col-md-12">
                <div class="card">
                   <div class="card-header">
                    ...
                    <?php include('../../backend/modal/modalAddDoc.php'); ?>
                    </div>
                    <div class="card-tools">
                    <a href="../medicos/reporte.php" class="btn btn-info btn-border btn-round btn-sm mr-2">
...
<?php if(count($data)>0):?>
          ...
          <td><?php echo $d->dnidoc  ?></td>
          <td><?php echo $d->nomdoc  ?>&nbsp;<?php echo $d->apedoc  ?></td>
     ...
     <?php  } ?>         
          ...
          <button onclick="location.href='../medicos/edit.php?id=<?php echo $d->coddoc ?>'" class="btn btn-link btn-primary btn-lg"  title="" data-original-title="Edit Task">
          <i class="fa fa-edit"></i>
          </button>

          <button onclick="location.href='../medicos/delete.php?id=<?php echo $d->coddoc ?>'" class="btn btn-link btn-danger btn-lg" title="" data-original-title="Delete Task">
          <i class="fa fa-times"></i>
          </button>

          <button onclick="location.href='../medicos/profile.php?id=<?php echo $d->coddoc ?>'" class="btn btn-link btn-warning btn-lg"   title="" data-original-title="profile Task">
