...
$this->Cell(150, 8, 'Medicos',0,1);

$this->SetY(45);
$this->SetX(247);
$this->SetFont('Arial','',8);
$this->Cell(40, 8, utf8_decode('Reporte de medicos'));
...
$pdf->Cell(75, 12, utf8_decode('Medico'),1,0,'C',1);
$pdf->Cell(35, 12, utf8_decode('Especialidad'),1,0,'C',1);
$pdf->Cell(35, 12, utf8_decode('Teléfono'),1,0,'C',1);
$pdf->Cell(35, 12, utf8_decode('Género'),1,0,'C',1);
$pdf->Cell(35, 12, utf8_decode('Nacimiento'),1,1,'C',1);
...
$pdf->Cell(25, 8, utf8_decode($row['coddoc']),'B',0,'C',1);
$pdf->Cell(35, 8, utf8_decode($row['dnidoc']),'B',0,'C',1);
$pdf->Cell(75, 8, utf8_decode($row['nomdoc']),'B',0,'C',1);
$pdf->Cell(35, 8, utf8_decode($row['nombrees']),'B',0,'C',1);
$pdf->Cell(35, 8, utf8_decode($row['telefo']),'B',0,'C',1);
$pdf->Cell(35, 8, utf8_decode($row['sexo']),'B',0,'C',1);
$pdf->Cell(35, 8, utf8_decode($row['fechanaci']),'B',1,'C',1);
