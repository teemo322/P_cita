     ...
     <div class="page-header">
       ...
       <div class="row">
               ...
               <div class="card-header">
                    <div class="card-title">Eliminar</div>
               </div>  
               <div class="card-body">
               <?php 
  ...
  while($r = $sentencia->fetchObject()){
               ...
               <form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
                 ...
                 <div class="row">
                  <div class="col-md-12 col-lg-12">
                    ...
                    <label for="email2">¿Esta seguro de borrar el registro?</label>
                 ...
                 <div class="card-action">
                         <button type="submit" name="delete_custome" class="btn btn-success">Eliminar</button>
   ...
   No hay datos.
    ...
    <?php endif; ?>
     ...
     <?php
    include_once '../../backend/php/delete_custom.php'
?>
