             ...
             <div class="col-md-12">
                <div class="card">
                   <div class="card-header">
                    ...
                    <?php include('../../backend/modal/modalAddCus.php'); ?>
                    </div>
...
$sentencia = $connect->prepare("SELECT customers.codpaci, customers.dnipa,customers.nombrep,customers.apellidop ,customers.seguro,customers.tele,customers.sexo,customers.usuario,customers.clave,customers.cargo,customers.estado, customers.fecha_create  FROM customers ORDER BY codpaci DESC;");
 $sentencia->execute();
$data =  array();
if($sentencia){
...
<?php if(count($data)>0):?>
          ...
          <td><?php echo $d->dnipa  ?></td>
          <td><?php echo $d->nombrep  ?>&nbsp;<?php echo $d->apellidop  ?></td>
        
          <td><?php echo $d->tele  ?></td>
         
          <td>
       <?php    if($d->estado==1)  { ?> 
          <span class="text-success pl-3"><strong>Activo</strong></span>
               <?php  }   else {?> 
               
               <span class="text-danger pl-3"><strong>Inactivo</strong></span>
     <?php  } ?>         
          </td>
          <td>
          <div class="form-button-action">
          
          <button onclick="location.href='../pacientes/edit.php?id=<?php echo $d->codpaci ?>'" class="btn btn-link btn-primary btn-lg"  title="" data-original-title="Edit Task">
          <i class="fa fa-edit"></i>
          </button>

          <button onclick="location.href='../pacientes/delete.php?id=<?php echo $d->codpaci ?>'" class="btn btn-link btn-danger btn-lg" title="" data-original-title="Delete Task">
          <i class="fa fa-times"></i>
          </button>

          <button onclick="location.href='../pacientes/profile.php?id=<?php echo $d->codpaci ?>'" class="btn btn-link btn-warning btn-lg"   title="" data-original-title="profile Task">
          <i class="fa fa-smile"></i>
          </button> 

          <button onclick="location.href='../pacientes/create.php?id=<?php echo $d->codpaci ?>'" class="btn btn-link btn-success btn-lg"   title="" data-original-title="profile Task">
   ...
   No hay datos.
    ...
    <?php endif; ?>   
     ...
     <?php
    include_once '../../backend/php/add_custom.php'
?>
