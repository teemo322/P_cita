             ...
             <div class="col-md-12">
                <div class="card">
                   <div class="card-header">
                    ...
                    <?php include('../../backend/modal/modalAdduser.php'); ?>
                    </div>
                    <div class="card-tools">
                    <a href="../usuarios/reporte.php" class="btn btn-info btn-border btn-round btn-sm mr-2">
...
<?php if(count($data)>0):?>
     ...
     <?php  } ?>         
          ...
          <button onclick="location.href='../usuarios/edit.php?id=<?php echo $d->id ?>'" class="btn btn-link btn-primary btn-lg" data-toggle="modal"  title="" data-original-title="Edit Task">
          <i class="fa fa-edit"></i>
          </button> 

          <button onclick="location.href='../usuarios/delete.php?id=<?php echo $d->id ?>'" class="btn btn-link btn-danger btn-lg" data-toggle="modal"  title="" data-original-title="Delete Task">
          <i class="fa fa-times"></i>
          </button>

          <button onclick="location.href='../usuarios/pass.php?id=<?php echo $d->id ?>'" class="btn btn-link btn-warning btn-lg" data-toggle="modal"  title="" data-original-title="Delete Task">
          <i class="fa fa-key"></i>
          </button>
   ...
   No hay datos.
    ...
    <?php endif; ?>   
     ...
     <?php
    include_once '../../backend/php/add_user.php'
?>
