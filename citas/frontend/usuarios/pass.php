  ...
  while($r = $sentencia->fetchObject()){
        ...
        <?php foreach($data as $d):?>
               <form action="" enctype="multipart/form-data" method="POST"  autocomplete="off">
                 ...
                 <div class="row">
                  <div class="col-md-12 col-lg-12">
                    ...
                    <label for="email2">Nueva contraseña</label>
                    <input type="password" required class="form-control" name="newuser" placeholder="Enter new contraseña">
               ...
               <small id="emailHelp2" class="form-text text-muted">We'll never share your email with anyone else.</small>
                 ...
                 <div class="card-action">
                         <button type="submit" name="upd_pass" class="btn btn-success">Agregar</button>
   ...
   No hay datos.
    ...
    <?php endif; ?>
     ...
     <?php
    include_once '../../backend/php/upd_passw.php'
?>
