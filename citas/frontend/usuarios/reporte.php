...
$this->Cell(150, 8, 'Usuarios',0,1);

$this->SetY(45);
$this->SetX(247);
$this->SetFont('Arial','',8);
$this->Cell(40, 8, utf8_decode('Reporte de usuarios'));
...
$pdf->Cell(50, 12, utf8_decode('Usuario'),1,0,'C',1);
$pdf->Cell(135, 12, utf8_decode('Correo'),1,1,'C',1);
...
$stmt = $connect->prepare("SELECT * FROM usuarios ORDER BY id DESC");
...
$pdf->Cell(35, 8, utf8_decode($row['id']),'B',0,'C',1);
$pdf->Cell(50, 8, utf8_decode($row['nombre']),'B',0,'C',1);
$pdf->Cell(50, 8, utf8_decode($row['usuario']),'B',0,'C',1);
$pdf->Cell(135, 8, utf8_decode($row['email']),'B',1,'C',1);
